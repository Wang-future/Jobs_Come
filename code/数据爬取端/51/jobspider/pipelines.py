...
class JobspiderPipeline(object):
    def __init__(self, dbpool):
        try:
           ...
           self.filename = open("51job.json", "ab")
    ...
    def do_insert(self, cursor, item):
        ...
        insert_sql = "insert into positions51(COMPANY,WORKPLACE,DIPLOMA,_NUMBER,_DATE,SUPPLEMENT,POSITIONTYPE,KEYWORD,EXPERIENCE,SALARY) VALUES(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)"
