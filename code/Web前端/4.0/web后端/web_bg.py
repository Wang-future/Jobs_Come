    ...
    def run(self):
        while True:
            ...
            #print(len(str))
                ...
                #     return c
                #
                # make_snapshot(snapshot, pie_rich_label1().render(), userin+"1"+".png")
                #
                # t2base = []
                # t2salary = []
                ...
                # )
                # make_snapshot(snapshot, bar2.render(), userin+"2"+".png")
                # # shutil.copy("bar.png",  "F:")#复制图片到指定路径
                #
                # t3salary = []
                # for i in sql3:
                #     mycursor.execute(i)
                ...
                # )
                # make_snapshot(snapshot, bar3.render(), userin+"3"+".png")
                ...
                url = pie_rich_label4().render()
                save_fn = userin+"4"+".png"

                driver1 = webdriver.PhantomJS(executable_path='F:/phantomjs/phantomjs-2.1.1-windows/bin/phantomjs')
                time.sleep(10)
                driver1.get(url)
                data = driver1.title
                time.sleep(10)
                driver1.save_screenshot(save_fn)

                self.con.send(self.write_msg(("./web后端/java4.png")))
